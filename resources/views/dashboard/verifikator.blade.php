...
@section('head')
<title>Verifikator Peserta Seleksi</title>
<link href="{{ asset('plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet">
@endsection

@section('container')
<h1>Verifikator Peserta Seleksi</h1>
<p>digunakan untuk mengelola verifikator Peserta seleksi</p>
...
<script src="{{ asset('js/web/verifikator.js') }}"></script>

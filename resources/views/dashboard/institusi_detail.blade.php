...
@section('head')
<title>Institusi Detail</title>
<link href="{{ asset('plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet">
@endsection

@section('container')
<h1 id="detail_judul">Institusi Detail</h1>
<p>digunakan untuk mengatur data detail institusi</p>
...
<script>
    var institusi_id="{{ $institusi_id }}";    
</script>
<script src="{{ asset('js/web/institusi_detail.js') }}"></script>
